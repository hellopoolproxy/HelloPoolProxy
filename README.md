...
- 依赖命令：iptables，ipset。
- 一台国外VPS，不要用国内VPS！香港或是美国，新加坡，韩国，日本等，国内的基本都被封了无法中转，另外下载拉取github程序困难。
...
### 注意：矿池代理中转程序hellominer的客户端，用于安装在矿机本地局域网，为所有专业矿机及显卡矿机提供统一入口，上级对接hellominer的ws协议端口，建立加密伪装隧道。可制作加密盒子放置于局域网内，采用Golang语言开发，性能稳定优异。支持安装为系统服务，开机自启动，支持进程守护运行，程序自动调整连接数限制。
